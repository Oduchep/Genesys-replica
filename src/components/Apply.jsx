...
class Apply extends React.Component {
    render() {
        return (
            <div>
                <section>
                    <img src={require("../resources/apply/Rectangle 42.png")} alt="computer keyboard"/>
                    <div>
                ...
                <section>
                    <img src={require("../resources/apply/Photo.png")} alt="computer keyboard"/>
                    <h1> How To Get In </h1>
                    ...
                    <p> Introduce yourself to us by filling out our 
                        ...
                        the physical and technical assessment.</p>
                        <p> APPLY HERE </p>
